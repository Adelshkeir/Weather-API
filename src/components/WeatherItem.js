  ...
  render() {
    return (
      ...
      <div className="weather_information">
        ...
        <p id="temp_txt"><strong>Temperature   </strong>
        <span id="temp_from"> 10°C</span> to <span id="temp_to"> 11°C </span>
        </p>
<p id="humidity_txt"><strong> Humidity</strong>
...
<div className="temp_hours">
  ...
  <div className="time time3"><p>3:00</p>
    <img src={partlycloudy} alt="Weather status "></img>
    <p>8°C</p>
  </div>

  <div className="time time6"><p>6:00</p>
  <img src={partlycloudy} alt="Weather status"></img>
  <p>9°C</p>
  </div>

  
  <div className="time time9"><p>9:00</p>
  <img src={clear} alt="Weather status"></img>
  <p>14°C</p>
  </div>

  <div className="time time12"><p>12:00</p>
  <img src={clear} alt="Weather status"></img>
  <p>17°C</p>
  </div>
  
  <div className="time time15"><p>15:00</p>
  <img src={clear} alt="Weather status"></img>
  <p>18°C</p>
  </div>

  <div className="time time18"><p>18:00</p>
  <img src={clear} alt="Weather status"></img>
  <p>16°C</p>
  </div>

  <div className="time time21"><p>21:00</p>
  <img src={partlycloudy} alt="Weather status"></img>
  <p>13°C</p>
  </div>
